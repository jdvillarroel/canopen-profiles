...
typedef struct {
    ...
    OD_obj_record_t o_6100_generalPressures[3];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6100_generalPressures = {
        {
            .dataOrig = &OD_PERSIST_COMM.x6100_generalPressures.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6100_generalPressures.pressure,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6100_generalPressures.SIUnit,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6100, 0x03, ODT_REC, &ODObjs.o_6100_generalPressures, NULL},
